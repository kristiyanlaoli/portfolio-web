      ...
      <div className=" bg-slate-850 px-6 pt-20 -mt-1 pb-24 sm:mx-8 sm:px-16 md:mx-16 lg:mx-20 xl:mx-24 xl:px-20">
        ...
        <div>
          <div className="lg:grid lg:grid-cols-2 gap-x-6">
            <a href="/writing" className="w-full  hover:scale-[105%] p-3 mb-6 bg-slate-850 border-2 border-slate-200 rounded-md  lg:p-6">
            ...
            <a href="/writing2" className="w-full hover:scale-[105%] p-3 mb-6 border-2 border-slate-200 rounded-md lg:p-6">
              <h2 className="font-bold text-2xl text-slate-200 mb-4">
