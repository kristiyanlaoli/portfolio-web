    ...
    <>
      <div className=" bg-zinc-50 dark:bg-slate-900 px-6 pt-20 -mt-1 pb-24 sm:mx-8 sm:px-16 md:mx-16 lg:mx-20 xl:mx-24 xl:px-20">
        ...
        <div>
          <div className="">
            <a href="/tulisan2">
              <div className="w-full group  hover:scale-[105%] p-3 mb-6 border-2 border-slate-600 dark:border-slate-200 rounded-md lg:p-6">
                <h2 className="font-bold text-2xl text-slate-700 dark:text-slate-200 mb-4">
                  My Gambling Decision: Become A Developer
                </h2>

                <p className="text-lg text-slate-600 dark:text-slate-300 mb-4 line-clamp-2">
                ...
                <button className="group  relative  text-lg font-bold text-slate-500 dark:text-slate-300  p border-slate-300 hover:text-loved hover:border-[#2cfc21]">
                  Read More
